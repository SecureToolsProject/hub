...
Tools local-first, privacy-conscious software ecosystem. It provides a minimal static site in
`public/` and records the ecosystem's shared boundaries in `docs/`.
